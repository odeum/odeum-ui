...
var fadeInModal = (0, _styledComponents.keyframes)(['0%{opacity:0;}100%{opacity:1;}']);

var StyledModal = exports.StyledModal = (0, _styledComponents2.default)(_reactModal2.default).withConfig({
...
var StyledModalHeader = exports.StyledModalHeader = _styledComponents2.default.div.withConfig({
...
var StyledModalHeaderIcon = exports.StyledModalHeaderIcon = _styledComponents2.default.div.withConfig({
    displayName: 'ModalStyles__StyledModalHeaderIcon'
})(['margin-right:5px;']);

var StyledModalHeaderTitle = exports.StyledModalHeaderTitle = _styledComponents2.default.div.withConfig({
    displayName: 'ModalStyles__StyledModalHeaderTitle'
})(['float:left;']);

var StyledModalHeaderClose = exports.StyledModalHeaderClose = _styledComponents2.default.div.withConfig({
    displayName: 'ModalStyles__StyledModalHeaderClose'
})(['float:right;margin-left:auto;cursor:pointer;']);

var StyledModalContent = exports.StyledModalContent = _styledComponents2.default.div.withConfig({
