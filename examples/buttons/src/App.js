...
class App extends Component {
	...
	render() {
		...
		return (
			<div>
				<Header>					
					<Logo size={'100px'} rotate={this.state.isChecked} />
					<Heading size={1} weight={500}>ODEUM UI - Buttons Example</Heading>
				</Header>

				
				<p>ODEUM UI (odeum-ui) are a component collection of simple visual UI primitives build for ODEUM Code. All components are build with styled-components and ReactJS</p>
